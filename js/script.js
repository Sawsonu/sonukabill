  ...
  function calculateBill() {
    ...
    if (daysLeft < 5) {
      ...
      billCountdownRow = `<tr><td colspan="2" class="billCountdown ${urgencyClass}">${daysLeft} day${daysLeft !== 1 ? 's' : ''} left for bill generation</td></tr>`;
    }
  ...
  function renderHistory() {
    ...
    let html = `<h3>History (${currentMeter === "neeche" ? "Neeche Ghar" : "Uper Ghar"})</h3><table><tr><th>Date</th><th>Units</th><th>Total</th></tr>`;
  ...
  document.getElementById("meterSelect").addEventListener("change", switchMeter);
